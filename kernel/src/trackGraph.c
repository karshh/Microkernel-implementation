...
void TrackGraphInitA(TrackGraph * t) {
    ...
    node[sensor2i("B13")].nextNodeDistance = 224+32;
    ...
    node[sensor2i("C02")].nextNodeDistance = 228+32;
    ...
    node[sensor2i("D01")].nextNodeDistance = 227+32;
    ...
    node[sensor2i("E01")].nextNodeDistance = 222+32;
    ...
    node[switch2i(14)].SnextNodeDistance = 445;
